...
void PlayScene::Update()
{
	...
	/*m_pPlayer->SetCurrentDirection(EventManager::Instance().GetMousePosition());*/
	// Make a Decision
...
void PlayScene::HandleEvents()
{
	EventManager::Instance().Update();
		...
		if (m_pPlayer->GetTransform()->position.x == 700.0f)
		{
...
void PlayScene::Start()
{
	...
	m_decisionTree = new DecisionTree(m_pStarShip); // using overloaded constructor
